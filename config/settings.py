...
# Validate and format R2 endpoint
r2_endpoint = os.getenv('R2_ENDPOINT_URL', 'https://r2.cloudflarestorage.com')
if r2_endpoint and not r2_endpoint.startswith(('https://', 'http://')):
...
SITEMAP_FOLDER = os.getenv('SITEMAP_FOLDER', "sitemaps/")
